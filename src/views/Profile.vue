<template>
  <div class="grey lighten-5">
    ...
    <div class="profile">
      ...
      <button v-show="isUser" class="follow">Edit Profile</button>
      <button v-show="isFriend === true" @click="removefriend()" class="follow">Remove Friend</button>
      <button
        v-show="isFriend === false && !isSent"
        @click="SendRequest(username)"
        class="follow"
      >
        Add Friend
      </button>
      ...
      <div class="friends">
        <i class="fas fa-heart"
          ><span
            >{{ userDetails.frcount }} Friend<span
              v-show="userDetails.frcount > 1"
              >s</span
            ></span
          ></i
        >
    ...
    <button
      v-if="username !== $store.state.auth.username"
      @click="SendRequest(username)"
    >
      Add Friend
    </button> -->
